...
export default function Queue({ queueOpen }: { queueOpen: boolean }) {
  ...
  return (
    <div className="w-full h-full">
      <div className={"flex items-center justify-between px-4 mb-[25px] pr-8 transition-all duration-700 " + (queueOpen ? "opacity-0 mt-[-17vh]" : "opacity-100")}>
      ...
      <div className={"w-full transition-all duration-800 min-h-[37.8vh] bg-[#262534] pr-5 rounded-tl-[60px] " + (queueOpen ? "h-[100vh]" : "h-[42vh]")}>
